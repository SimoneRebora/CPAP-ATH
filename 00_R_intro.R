...
### Suggested activity 
# Create a new string (e.g. my_new_string)
# and split it by space (using the strsplit function)
# You can write and activate the code down here:
...
# which splits each string by space
# You can write and activate the code down here:
